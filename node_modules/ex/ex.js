...
if (typeof window != 'undefined' && typeof window.exSetup != 'undefined') {
    ...
    console.log('ex: window exists');
} else if (typeof global != 'undefined' && typeof global.exSetup != 'undefined') {
    exSetup = global.exSetup;
    console.log('ex: global exists typeof global: ' + typeof global);
} else {
    console.log('ex: neither window nor global exists');
...
(function(root, undefined) {
    ...
    function initializeRates() {
        ...
        //exSetup.rates = typeof exSetup.rates != 'undefined' ? exSetup.rates : util.exSetup.rates;

        console.log("ex.js exSetup: " + JSON.stringify(exSetup));
        ex.rates = exSetup.rates || util.exSetup.rates;
        ex.base = exSetup.base || util.exSetup.base;

        // Default from / to currencies for conversion via ex.convert():
        ex.settings = {
            from: exSetup.from || ex.base,
            to: exSetup.to || ex.base
        };
        console.log("value of ex.settings: " + JSON.stringify(ex.settings));
